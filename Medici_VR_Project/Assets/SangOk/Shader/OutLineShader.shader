Shader "Custom/Outline"
{
	...
	{
		_MainTex("Main Texture (RBG)", 3D) = "white" {} // Allows for a texture property
		_Color("Color", Color) = (255,255,255,255) // Allows for a color property

		_OutlineTex("Outline Texture", 3D) = "white" {}
